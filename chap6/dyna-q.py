...
class DynaQ:
    def __init__(self, ncol, nrow, epsilon, alpha, gamma, n_planning, num_action=4):
    ...
    def update(self, s0, a0, r, s1):
        ...
        for _ in range(self.n_planning):
            (s, a), (r, s_) = random.choice(list(self.model.items()))   # 随机选择曾经遇到过的动作状态对
